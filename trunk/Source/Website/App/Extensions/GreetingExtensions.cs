        ...
        public static Greeting GenerateGreeting(this Greeting greeting, WhoisEnhancedRecord whois)
        {
            ...
            if(whois.IsFriendly)
            {
                msg = string.Format(
                    ...
                    whois.Organization.Capitalize(), MyWebPresenceExtensions.EmailAccount, MyWebPresenceExtensions.SkypeAccount, MyWebPresenceExtensions.LinkedInAccount);
            }
            else if (whois.IsFilterMatch)
            {
                if (whois.IsFilterMatch("calgary") || whois.IsFilterMatch("alberta"))
                {
                    msg = string.Format(
                        ...
                        MyWebPresenceExtensions.PublicCalendar, MyWebPresenceExtensions.EmailAccount);
                }
            }
            else if (whois.IsReferrerMatch)
            {
                if (whois.IsReferrerMatch("twitter"))
                {
                    msg = string.Format(
                        ...
                        Prefix(), MyWebPresenceExtensions.TwitterAccount, MyWebPresenceExtensions.FacebookAccount, MyWebPresenceExtensions.FriendfeedAccount);
                }
                else if (whois.IsReferrerMatch("github"))
                {
                    msg = string.Format(
                        ...
                        Prefix(), MyWebPresenceExtensions.GoogleCodeAccount, Postfix());
                }
                else if (whois.IsReferrerMatch("linkedin") || whois.IsReferrerMatch("monster"))
                {
                    msg = string.Format(
                        ...
                        MyWebPresenceExtensions.EmailAccount, MyWebPresenceExtensions.SkypeAccount);
                }
                else if (whois.IsReferrerMatch("delicious"))
                {
                    msg = string.Format(
                        ...
                        MyWebPresenceExtensions.DeliciousAccount, MyWebPresenceExtensions.TwitterAccount, Postfix());
                }
                else if (whois.IsReferrerMatch("friendfeed"))
                {
                    msg = string.Format(
                        "{0} You might also be interested in visiting {1}. {2}",
                        Prefix(), MyWebPresenceExtensions.LinkedInAccount, Postfix());
                }
                else if (whois.IsReferrerMatch("facebook"))
                {
                    msg = string.Format(
                        ...
                        Prefix(), MyWebPresenceExtensions.TwitterAccount, Postfix());
                }
                else if (whois.IsReferrerMatch("code.google"))
                {
                    msg = string.Format(
                        ...
                        Prefix(), MyWebPresenceExtensions.EmailAccount, Postfix());
                }
                else if (whois.IsReferrerMatch("mail.google"))
                {
                    msg = string.Format(
                        "Thanks for looking me up. Why not {0} or send me ({1}) an email. :)",
                        MyWebPresenceExtensions.SkypeAccount, MyWebPresenceExtensions.EmailAccount);
                }
                else if (whois.IsReferrerMatch("stackoverflow") || whois.IsReferrerMatch("odetocode") || whois.IsReferrerMatch("asp.net"))
                {
                    msg = string.Format(
                        ...
                        Prefix(), MyWebPresenceExtensions.GoogleCodeAccount, MyWebPresenceExtensions.GitHubAccount, MyWebPresenceExtensions.TwitterAccount, Postfix());
                }
            }
            else
            {
